...
CREATE TABLE IF NOT EXISTS movie (
    ...
    INSERT INTO movie (movieName, movieActors, movieDescription, movieAgeRes, movieStartDate, movieEndDate, movieLength, movieMaxSeats, movieRemainingSeats, movieTheaterID)
    VALUES 
